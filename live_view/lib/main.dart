...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  TextEditingController _textFieldController = TextEditingController(
      text: "rtsp://admin:admin123@192.168.29.39:554/streaming/channels/201");
      //rtmp://34.70.40.166:1935/LiveApp/815794454132232781694481
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text('Live view example'),
      ),
      body: Column(
        children: <Widget>[
          Expanded(
